...
if __name__ == "__main__":
    fista_path = os.path.join(RESULTS_FOLDER, "fista_test_7")
    ...
    x = img.ravel()
    os.makedirs(fista_path, exist_ok=True)
    ...
    for M_ratio in M_list:
        ...
        for k_ratio in k_list:
            ...
            y = A @ x
            size_path = os.path.join(fista_path, f"{M_ratio}_{k_ratio}")
                    ...
                    for algo in algo_list:
                        ...
                        for lam_ in lambda_list:
                            ...
                            summary_path = os.path.join(
                                size_path,
                                f"{algo.value}_{tol}_{max_iter}_{lam_}_summary.txt",
                            )
